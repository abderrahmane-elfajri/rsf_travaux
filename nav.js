      ...
      <div class="wrap-wide">
        <div class="footer-grid">
          <div class="footer-brand">
            ...
            <p class="footer-desc">Entreprise générale de bâtiment forte de 21 ans d'expérience. Casablanca et partout au Maroc. Travaux clé en main avec garantie décennale.</p>
          </div>
          ...
          <div class="footer-col footer-col-contact">
            ...
            <ul class="footer-contact-list">
              ...
              <li class="footer-city-tag">Casablanca et partout au Maroc</li>
            </ul>
          </div>
        </div>
