...
(function () {
      ...
      <div class="nav-inner">
        ...
        <div class="nav-menu-wrapper" id="nav-menu">
          <div class="nav-mobile-header">
            ...
            <span class="nav-mobile-location">Casablanca et partout au Maroc</span>
          </div>
          ...
          <div class="nav-mobile-bottom">
            ...
            <div class="nav-mobile-info">
              ...
              <span class="nav-mobile-city">21 ans d'expérience · Casablanca et partout au Maroc</span>
            </div>
          </div>
        </div>
      ...
      <div class="wrap-wide">
        <div class="footer-grid">
          <div class="footer-brand">
            ...
            <p class="footer-desc">Entreprise générale de bâtiment forte de 21 ans d'expérience à Casablanca et partout au Maroc. Travaux clé en main.</p>
          </div>
  ...
  // Fixed Floating WhatsApp button (across all pages)
  if (!document.querySelector(".floating-whatsapp")) {
    ...
    floatBtn.innerHTML = `
      ...
      <span class="floating-wa-text">Discuter</span>
    `;
